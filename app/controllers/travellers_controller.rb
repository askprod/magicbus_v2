class TravellersController < ApplicationController
  ...
  private
    ...
    def traveller_params
      params.require(:traveller).permit(:accompanied_minor, :additional_comment, :medical_condition, :valid_passport, :sanitary_conditions, :phone_validation, :gender, :insurance_status, :cart_id, :first_name, :last_name, :address, :phone_number, :zip_code, :birth_date, :nationality, :email_address, restriction_travellers_attributes: [:food_restriction_id, :id, :_destroy, food_restriction_attributes: [:name_en, :id]], diet_travellers_attributes: [:food_diet_id, :id, :_destroy, food_diet_attributes: [:name_en, :id]])
    end
end
